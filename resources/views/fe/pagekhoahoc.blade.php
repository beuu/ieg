...
<div class="container-fluid">
	...
	<h1 class="title_block">Đổi tên là những khoảnh khắc bật sáng</h1>
	<div class="container">
				...
				<form class="row" action="{{ route('nangluc')}}" method="POST" id="nangluc">
					...
					<div class="col-md-12 flex-box form-flex">
						...
						<div class="col-4-cust flex-box flext-wrapRev">
							...
							<a class="btn_block04 bg_xanhnuocbien" href="#" onclick="document.getElementById('nangluc').submit();">Gửi đi</a>
						</div>
					</div>
				</form>
			</div>
